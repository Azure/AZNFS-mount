...
- [AZNFS-mount #94](https://github.com/Azure/AZNFS-mount/pull/94)
  (NFSv3) Adding functionality to support non-interactive installation for the package.
- [AZNFS-mount #93](https://github.com/Azure/AZNFS-mount/pull/93)
  (NFSv3) Adding CHANGELOG.md file, editing Readme.md and printing AZNFS version in aznfswatchdog.

## [2.0.0]- December 2023
- [AZNFS-mount #89](https://github.com/Azure/AZNFS-mount/pull/89)
  (NFSv3) Adding the resiliency and addressing hung issue for Regional Accounts with AZNFS-mount.
...
- [AZNFS-mount #92](https://github.com/Azure/AZNFS-mount/pull/92)
  (NFSv3) Adding Dialog Box for user consent for Auto-update feature of AZNFS-mount.
...
- [AZNFS-mount #83](https://github.com/Azure/AZNFS-mount/pull/83)
  (NFSv3) Corrected syntax error in the code
