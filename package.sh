...
generate_rpm_package()
{
    ...
    cp -avf ${SOURCE_DIR}/src/update.sh ${STG_DIR}/${rpm_dir}/tmp${rpm_buildroot_dir}/${rpm_pkg_dir}${opt_dir}/
...
generate_tarball_package() {
    ...
    cp -avf ${SOURCE_DIR}/src/update.sh ${STG_DIR}/tarball/${tar_pkg_dir}${opt_dir}/
    ...
    chmod 0755 ${STG_DIR}/tarball/${tar_pkg_dir}${opt_dir}/update.sh
...
cp -avf ${SOURCE_DIR}/src/update.sh ${STG_DIR}/deb/${pkg_dir}${opt_dir}/
