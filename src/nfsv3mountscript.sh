...
#
# The following functions have been moved to common.sh for reuse by NFSv4:
#   is_host_ip, is_link_ip, is_pinging, octets_in_ipv4_prefix,
#   search_free_local_ip_with_prefix, get_free_local_ip
#
